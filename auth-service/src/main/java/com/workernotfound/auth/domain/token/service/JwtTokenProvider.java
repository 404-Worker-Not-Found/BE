...
import com.workernotfound.auth.global.security.InvalidAccessTokenException;
import com.workernotfound.auth.global.security.JwtProcessingException;
...
public class JwtTokenProvider {
	...
	public String createAccessToken(Long authAccountId, Long memberId, MemberRole role) {
		...
		String unsignedToken =
				"%s.%s"
						.formatted(
								encode(HEADER_JSON), encode(createPayloadJson(authAccountId, memberId, role, now)));
	...
	private String createPayloadJson(
			Long authAccountId, Long memberId, MemberRole role, Instant issuedAt) {
		return """
