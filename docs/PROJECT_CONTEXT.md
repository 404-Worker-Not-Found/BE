...
- Confirmation commands persist stable idempotency keys and external resource IDs before advancing. A lease prevents concurrent coordinators, expired work can resume, and failed compensation retains unresolved resources for a later retry.
